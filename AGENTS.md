...
2. `data/applicants.ts` — the entity, the people behind it with their titles, the date it disclosed. String counts are derived from `data/claims.ts`, never stored.
